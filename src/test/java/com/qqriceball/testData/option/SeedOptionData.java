...
public class SeedOptionData {
    ...
    public static final TestOption NORMAL_SIZE =
            new TestOption(3,"飯量正常",OptionTypeEnum.RICE_SIZE.getCode(),
                    DefaultEnum.YES.getCode(), 0, StatusEnum.ACTIVE.getCode());
    public static final TestOption LARGE_SIZE =
            new TestOption(4,"飯量多",OptionTypeEnum.RICE_SIZE.getCode(),
    ...
    public static final TestOption MILD_SPICY =
            new TestOption(6,"微辣",OptionTypeEnum.SPICE_LEVEL.getCode(),
                    DefaultEnum.NO.getCode(),0,StatusEnum.ACTIVE.getCode());
    public static final TestOption MEDIUM_SPICY =
            new TestOption(7,"中辣",OptionTypeEnum.SPICE_LEVEL.getCode(),
                    DefaultEnum.NO.getCode(),0, StatusEnum.ACTIVE.getCode());
    public static final TestOption HOT_SPICY =
            new TestOption(8,"大辣",OptionTypeEnum.SPICE_LEVEL.getCode(),
                    DefaultEnum.NO.getCode(),0, StatusEnum.ACTIVE.getCode());

    // DRINK_TEMPERATURE
    public static final TestOption HOT =
            new TestOption(9,"冷",OptionTypeEnum.DRINK_TEMPERATURE.getCode(),
                    DefaultEnum.YES.getCode(), 0, StatusEnum.ACTIVE.getCode());
    public static final TestOption COLD =
            new TestOption(10,"熱",OptionTypeEnum.DRINK_TEMPERATURE.getCode(),
                    DefaultEnum.NO.getCode(),0, StatusEnum.ACTIVE.getCode());
